...
import service from "../../assets/ayshman-doc.png"
...
import doct11 from "../../assets/doct11.png"
import doct12 from "../../assets/doct12.jpg"
import doct13 from "../../assets/doct13.jpg"
            ...
            >
                <div
                    ...
                    <motion.div
                        ...
                        <p className='text-3xl font-semibold text-center'>You’re not just in good hands — you’re in trusted hearts. </p>
                        <p className='text-lg text-center'>Where every life matters, and every patient feels at home — safe, supported, and cared for.
                        </p>
                    </motion.div>
                    <motion.div
                        ...
                        transition={{ duration: 1.5 }}
                        whileInView={{ opacity: 1 }}
                        className='w-full md:w-[80%] lg:w-[100%]'><img src={bannerf} alt="hero" className='h-[400px]  shadow-black' /></motion.div>
                </div>
                            ...
                            <motion.div
                                ...
                                <div>
                                    <div className='flex justify-start  gap-2 items-center '>
                                        ...
                                        <p className='text-xl font-semibold'>Expert Medical Team</p>
                                    </div>
                                    <p className='text-sm'>Our hospital is staffed with highly qualified doctors and specialists dedicated to exceptional patient care</p>
                                </div>
                            </motion.div>
                            <motion.div
                                ref={ref}
                                ...
                                <p className='text-sm'>We use state-of-the-art medical equipment to ensure accurate diagnosis and effective treatment.</p>
                            </motion.div>
                        </div>
                            ...
                            <motion.div
                                ...
                                <div>
                                    <div className='flex justify-start  gap-2 items-center '>
                                        ...
                                        <p className='text-xl font-semibold'>24/7 Emergency Services</p>
                                    </div>
                                    <p className='text-sm'>Round-the-clock emergency care is available to handle any medical urgency with speed and expertise.</p>
                                </div>
                            </motion.div>
                            <motion.div
                                ref={ref}
                                ...
                                <div>
                                    <div className='flex justify-start  gap-2 items-center '>
                                        ...
                                        <p className='text-xl font-semibold'>Patient-Centered Approach</p>
                                    </div>
                                    <p className='text-sm'>We prioritize your comfort, safety, and satisfaction throughout your healthcare journey.</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <div className='h-full max-w-7xl flex flex-col m-auto justify-center items-center overflow-auto'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex gap-3 '>
                            ...
                            <div className="w-[270px] h-[300px] border border-gray-200 rounded-lg bg-[#f3f4fc] shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={doct13} alt="" />
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Vikram Deshmukh</h5>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={doct1} alt="" />
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Aarav Kapoor</h5>
                                    <span className="text-sm text-black">Surgeon</span>
                                    <div className="flex mt-4 md:mt-6">
                                        <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Book Appointment</a>
                                    </div>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    ...
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Shreyash Nair</h5>
                                    <span className="text-sm text-black">Surgeon</span>
                                    <div className="flex mt-4 md:mt-6">
                                        <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Book Appointment</a>
                                    </div>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={doct11} alt="" />
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Sneha Iyer</h5>
                                    <span className="text-sm text-black">Gynecologist</span>
                                    <div className="flex mt-4 md:mt-6">
                                        <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Book Appointment</a>
                                    </div>
                                </div>
                        ...
                        <div className='flex gap-3'>
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    ...
                                    <span className="text-sm text-black">Orthopedic Surgeon</span>
                                    <div className="flex mt-4 md:mt-6">
                                        <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Book Appointment</a>
                                    </div>
                                </div>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={doct12} alt="" />
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Manish Bansal</h5>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    ...
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Neeraj Reddy</h5>
                                    <span className="text-sm text-black">Oncologist</span>
                                    <div className="flex mt-4 md:mt-6">
                                        <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Book Appointment</a>
                                    </div>
                                </div>
                            ...
                            <div className="w-[270px] h-[300px] bg-[#f3f4fc] border border-gray-200 rounded-lg shadow flex justify-center">
                                <div className="flex flex-col items-center justify-center ">
                                    ...
                                    <h5 className="mb-1 text-xl font-medium text-black">Dr.Anjali Sinha </h5>
                                    <span className="text-sm text-black">Pediactrition</span>
                                    <div className="flex mt-4 md:mt-6">
                ...
                <div className=' max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto '>
                    ...
                    <motion.div
                        ...
                        <div className='flex flex-col items-start py-5 p-5 w-[450px] shadow-xl bg-[#E9EDC9] shadow-violet-400 rounded-lg'>
                            ...
                            <div>
                                <p className=''>I had a wonderful experience at HMS. The staff was incredibly caring, and the doctors took the time to explain everything clearly. The facilities were modern, and I felt truly comfortable throughout my treatment. Highly recommend!"
